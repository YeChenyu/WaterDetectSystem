...
public class DateUtils
{
	...
	*/ 
	...
	public static String getCurrTimeHHMMSS()
	{
	...
	public static String getCurrDateMMDD()
	{
	 ...
	 * @return
	 */
	public static String getTimeStringDisplay(Context context ,String getDateString) {
	 ...
	 * @return
	 */
	public static String getTimeDisplay(Context context,String getDateString) {
	    return getTimeDisplay(context,getDateString, true);
	}

	public static String getTimeDisplay(Context context,String getDateString, boolean timeZone) {
	 ...
	 * @return
	 */
	public static String formatNewThingDetailTime(Context context,String dateString) {
	    return formatNewThingDetailTime(context,dateString, 0);
	}
	/**
	 * @param dateString
	 ...
	 * @return
	 */
	public static String formatNewThingDetailTime(Context context,String dateString, int type) {
	 ...
	 * @return
	 */
	public static String formatTweetDetailTime(Context context, String dateString, boolean isKtv) {
