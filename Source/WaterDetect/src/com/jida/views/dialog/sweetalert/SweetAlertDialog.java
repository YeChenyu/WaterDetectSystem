package com.jida.views.dialog.sweetalert;
...
public class SweetAlertDialog extends AlertDialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sweetalert_alert_dialog);
        LogUtils.e("onCreate()");
    ...
    private void restore () {
        ...
        mConfirmButton.setBackgroundResource(R.drawable.sweetalert_button_selector);
    ...
    public SweetAlertDialog setViews(View v){
    	LogUtils.e("setView");
    	if(v != null)
    		mContentChild = v;
    	...
    	return (SweetAlertDialog)this;
    }
    
    public View getView(){
    	return mContentView;
    }
    private void setContentViews(View v){
        ...
        if (mDialogView != null) {
            ...
            switch (mAlertType) {
                ...
                case SUCCESS_TYPE:
                    ...
                    break;
                case WARNING_TYPE:
                    mConfirmButton.setBackgroundResource(R.drawable.sweetalert_button_confirm_selector);
    ...
    public SweetAlertDialog showConfirmButton (boolean isShow) {
    	mShowConfirml = isShow;
        if (mConfirmButton != null) {
        	mConfirmButton.setVisibility(mShowConfirml ? View.VISIBLE : View.GONE);
        }
        return this;
    }
